...
class ProductInfo extends Component{
    ...
    handleSelectSize(value){
        this.setState({ selectedSize: value.toUpperCase()})
    }
    ...
    render(){
        const { handleSelectColor, handleSelectSize, handleAddOnceToCart } = this;
        const { selectedColor, selectedSize, dataProInfo, canAddToCart } = this.state;
